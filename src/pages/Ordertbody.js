            ...
            <div className="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div className="btn-group">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li><Link className="dropdown-item" to={`/updateorder/${props.orderId}`}>cancel</Link></li>
                        <li><Link id={props.key} onClick={event => props.deleteOrder(event, props.orderId)} className="dropdown-item" to="/deleteorder">Delivered</Link></li>
                      </ul>
                    </div>
              </div>
            </td>
